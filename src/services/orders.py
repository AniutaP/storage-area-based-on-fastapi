...
class OrderService:
    ...
    async def check_quantity_product(self, data: OrderDTO, db_session: AsyncSession) -> bool:
    ...
    async def create(self, data: OrderDTO, db_session: AsyncSession):
    ...
    async def update_by_id(self, id: str, data: OrderDTO, db_session: AsyncSession):
